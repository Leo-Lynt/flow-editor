    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <div class="flex-1 relative outline-none focus:outline-none" @drop="handleDrop" @dragover.prevent
        ...
        <VueFlow :nodes="nodes" :edges="edgesWithAttributes" @nodes-change="handleNodesChange"
          ...
          <Background :variant="BackgroundVariant.Dots" pattern-color="#e5e7eb" />
...
import { getTypeColor } from '@flow-forge/core/engine/dataTypes.js'
import {
  getHandleType as getHandleTypeFromSystem,
  getAcceptedTypes,
  isConnectionValid,
  validateConnection
} from '@flow-forge/core/engine/typeSystem.js'
...
:deep(.vue-flow__background) {
  @apply opacity-40 dark:opacity-25;
